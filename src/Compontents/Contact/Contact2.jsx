...
export default function Contact2() {
  return (
    <section className="py-10 mx-5 md:mx-10 lg:mx-20" aria-labelledby="contact-section">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 px-5 md:px-10 lg:px-25 2xl:px-60 items-stretch">

        {/* Form Column */}
        <div className="flex flex-col justify-between bg-white rounded-xl p-2">
          <h1 id="contact-section" className="font-bold py-3 text-2xl">Let's Connect & Explore.</h1>
