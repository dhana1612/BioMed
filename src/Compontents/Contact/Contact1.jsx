...
export default function Contact1() {
  return (
    <section className="py-10 mx-5 md:mx-10 lg:mx-20">
      <div className="bg-gray-100 rounded-4xl py-2 md:py-12 lg:py-25">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 px-5 md:px-10 lg:px-25 2xl:px-60">
          {/* Contact Info */}
          <div className="veritcalLine py-5">
